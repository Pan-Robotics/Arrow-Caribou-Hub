...
class CaribouHubClient:
    """Client for communicating with Caribou Hub server"""
    
    def __init__(self, server_url: str, drone_id: str, api_key: str, poll_interval: int = 5,
                 companion_id: Optional[str] = None):
        """
        Initialize the Caribou Hub client
        
        Args:
            server_url: Base URL of the Caribou Hub server (e.g., https://your-server.com)
            drone_id: Unique identifier for this drone (e.g., caribou_001)
        ...
        logger.info(f"Initialized Caribou Hub client for drone: {drone_id}")
    ...
    def handle_update_config_job(self, job: Dict) -> tuple[bool, Optional[str]]:
        ...
        try:
            ...
            config_file = payload.get('configFile', '/home/alexd/config/caribou_config.json')
    ...
    def run(self):
        ...
        """
        logger.info("Starting Caribou Hub client...")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Caribou Hub Raspberry Pi Client',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog='''
Examples:
  # Run with default settings
  python3 raspberry_pi_client.py --server https://your-server.com --drone-id caribou_001 --api-key abc123
  
  # Run with custom poll interval
  python3 raspberry_pi_client.py --server https://your-server.com --drone-id caribou_001 --api-key abc123 --poll-interval 10
        '''
    )
    ...
    parser.add_argument(
        '--server',
        required=True,
        help='Caribou Hub server URL (e.g., https://your-server.com)'
    )
    
    parser.add_argument(
        '--drone-id',
        required=True,
        help='Unique identifier for this drone (e.g., caribou_001)'
    )
