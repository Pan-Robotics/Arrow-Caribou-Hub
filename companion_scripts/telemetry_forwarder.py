...
then forwards to Caribou Hub via HTTP POST to tRPC endpoint.
...
Environment Variables:
    WEB_SERVER_URL - Caribou Hub base URL (e.g., https://your-domain.com)
...
class TelemetryForwarder:
    ...
    def start(self):
        ...
        self.logger.info("=" * 60)
        self.logger.info("🚀 Starting Caribou Hub Telemetry Forwarder")
        self.logger.info("=" * 60)
